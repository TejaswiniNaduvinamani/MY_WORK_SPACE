...
public class JoinDemo 
{
	...
	public static void main(String[] args) { 
		/* we have three threads and we need to run in the order T1, T2 and T3 i.e. T1 should start first and T3 should start last.
		 * You can enforce this ordering using join() method but join method must be called from run() method 
		 * because the thread which will execute run() method // will wait for thread on which join is called.*/
